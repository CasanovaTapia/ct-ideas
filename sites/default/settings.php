 ...
 * @endcode
 */
$settings['hash_salt'] = 'wSMMSqM2eiyE-L1V_AO444nouqMCpiqjapHvbrlsYgTcf3Sn5vEYQJlfTgVOnb-xabc6QrqSpA';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_ideas_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_ideas_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'ideas',
...
$config_directories['sync'] = 'sites/ideas.dd/files/config_mcJIbmYfLsv5BuffHXWiAisUV-a3RX5JJBNF3ypZ_ecFTrMJFBw40x5iPasheM2WDQO8TcgVLw/sync';
